...
class Complaint(models.Model):
	...
	status=models.CharField(max_length=120,choices=status_choice,default=complaintregistered)
	...
	# 	return Complaintid("crimefiles:detail", kwargs={"id":self.complaintid})	
